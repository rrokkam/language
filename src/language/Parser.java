...
class Parser {
    ...
    private Stmt classDeclaration() {
        ...
        consume(OPEN_BRACE, "Expect '{' before class body.");
        List<Stmt.Function> methods = new ArrayList<>();
        while (!check(CLOSE_BRACE) && !isAtEnd()) {
            methods.add(function("method"));
        }
        consume(CLOSE_BRACE, "Expect '}' after class body.");
        return new Stmt.Class(name, superclass, methods);
    }

    private Stmt.Function function(String kind) {
        Token name = consume(IDENTIFIER, "Expect " + kind + " name.");
        consume(OPEN_PAREN, "Expect '(' after " + kind + " name.");
        ...
        consume(OPEN_BRACE, "Expect '{' before " + kind + " body.");
    ...
    private Stmt forStatement() {
        consume(OPEN_PAREN, "Expect '(' after 'for'.");
        Stmt initializer;
        if (match(SEMICOLON)) {
            initializer = null;
        } else if (match(VAR)) {
